...
class Server {
  constructor() {
    ...
    this.pathIncidenciasDashBoard = "/api/incidenciasDashBoard";
    this.middleware();
    this.routes();
  }
  ...
  routes() {
    ...
    this.app.use(this.pathPermisos, require("../routes/permisos"));
    this.app.use(this.pathIncidenciasDashBoard, require("../routes/incidenciasDashboard"));
